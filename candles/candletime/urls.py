...
urlpatterns = [
    ...
    path('<int:candle_pk>/update-detail/<int:detail_pk>', views.detail_update, name="update_candle_detail"),
    path('<int:candle_pk>/delete-detail/<int:detail_pk>', views.detail_delete, name="delete_candle_detail"),
